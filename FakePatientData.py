...
if __name__ == "__main__":
    ...
    print(r" \copy raw_data.patients FROM 'C:\Users\jlynn\Data_Projects\hipaa_deidentification_pipeline\data\raw\patients.csv' DELIMITER ',' CSV HEADER;")
    print(r" \copy raw_data.medical_records FROM 'C:\Users\jlynn\Data_Projects\hipaa_deidentification_pipeline\data\raw\medical_records.csv' DELIMITER ',' CSV HEADER;")
    print(r" \copy raw_data.insurance FROM 'C:\Users\jlynn\Data_Projects\hipaa_deidentification_pipeline\data\raw\insurance.csv' DELIMITER ',' CSV HEADER;")
    print()